...
main (void) {
  ...
  try {
    ...
    model.add(IloMinimize(env, objective*objective)); // We minimise completion time squared, while keeping the rest of the model exactly as in load_balancing.cpp
   //*/
